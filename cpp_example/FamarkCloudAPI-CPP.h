...
size_t read_callback(char* dest, size_t size, size_t nmemb, struct api_data_type* request_ptr) {
...
size_t header_callback(char* head, size_t size, size_t nmemb, struct api_data_type* header_ptr) {
    size_t buffer_size = (size * nmemb);
...
size_t write_callback(char* source, size_t size, size_t nmemb, struct api_data_type* response_ptr) {
    size_t buffer_size = (size * nmemb);
